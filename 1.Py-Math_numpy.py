...
def Maths(data):
    ...
    return min,max,round(average,4)


data = random.randint(1,100,11)
print(data)
print("The calculated min, max and avg of data from the function are")
print(Maths(data)) # printing the returned values(min, max and avg)
